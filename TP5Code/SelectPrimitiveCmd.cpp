...
void SelectPrimitiveCmd::execute()
{
	...
	VisitorPrimitiveSelector visiteur = new VisitorPrimitiveSelector(this.m_type);
	visiteur.visitObjComposite(this.obj3d);
	this.m_selectObjContainer = visiteur.getSelectObjects;
}
